  ...
  return (
    <section className="animate-scan-line relative h-[360px] w-full overflow-hidden bg-gray-900 sm:h-[420px] md:h-[620px]" aria-label="כותרות ראשיות">
      <div className="absolute inset-0">
        <img src={currentPost.imageUrl} alt={currentPost.title} loading="eager" decoding="async" fetchPriority="high" className="h-full w-full object-cover opacity-85 transition-opacity duration-700" />

...
import { Clock, ChevronLeft, Loader2, Eye, Check, Share2 } from 'lucide-react';
...
export const PostCard: React.FC<PostCardProps> = ({ post, layout = 'grid' }) => {
  ...
  if (layout === 'list') {
    return (
      <article className="group flex gap-3 overflow-hidden rounded-[1.4rem] border border-gray-100 bg-white p-3 shadow-sm transition hover:-translate-x-1 hover:shadow-xl sm:gap-5 sm:rounded-[1.75rem] sm:p-4">

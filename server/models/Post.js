...
const postSchema = new mongoose.Schema({
  ...
  category: {
    type: String,
    enum: ['מבזקים', 'קהילה וחברה', 'כלכלה', 'פוליטיקה', 'ביטחון', 'תרבות ואומנות', 'משפט ופלילים', 'בריאות', 'מזג אוויר', 'תשתיות ותנועה', 'צפת והגליל', 'בתי כנסת בצפת', 'מסעדות כשרות', 'מקוואות', 'אטרקציות', 'שמחות', 'דעות', 'חינוך'],
    default: 'מבזקים'
  },
